import {Cricketer} from "./Modules/cricketer";

export const cricketersList: Cricketer[] = [
  ...
  {id: 2, firstName: 'Steve', lastName: 'Smith',age:40, dob:'1985-10-06',country: 'Australia', role: 'Batsman', netWorth:5,isActive: true ,imageUrl:"/assets/image2.jpeg"},
